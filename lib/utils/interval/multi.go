...
// Tick forces the interval to fire immediately regardless of how much time is left on
...
// reset resets the sub-interval entry with the provided key.
...
// push adds a new subinterval, overwriting any previous sub-intervals with the
// same key.
